...
export const feedEntries: FeedEntry[] = [
  {
    ...
    target: {
      ...
      description:
        'Analyze vaccination efficacy data to provide insights into vaccine performance.',
  ...
  },
  {
    ...
    target: {
      ...
      abstract:
        'Developing AI models to identify early biomarkers of neurodegeneration using multi-modal medical imaging data.',
  ...
  },
  {
    ...
    content: {
      ...
      authors: [users.sarahChen, users.jamesWilson, users.dominikus],
    },
    contributors: [
      {
  ...
  },
  {
    ...
    content: {
      ...
      type: 'comment',
      content:
        "Thank you for the feedback! We're currently working on extending this to regional models. Our preliminary results show promising accuracy improvements when incorporating local meteorological patterns and topographical data. ",
      timestamp: '2024-12-16 15:24:06.069373+00',
      ...
      parent: {
        ...
        type: 'comment',
        content:
          'The methodology presented here opens up exciting possibilities for climate modeling. The use of transformer architectures is particularly innovative.',
        timestamp: '2024-12-16 14:24:06.069373+00',
        hub: hubs.climateScience,
  ...
  },
  {
    ...
    content: {
      ...
      content:
        'Excellent methodology and comprehensive literature review. The discussion of thermal management challenges could be expanded.',
      timestamp: '2024-12-16 15:24:06.069373+00',
  ...
  },
  {
    ...
    content: {
      ...
      abstract:
        'Seeking researchers to conduct comprehensive water quality analysis in developing regions.',
      timestamp: '2024-12-13 13:24:06.069373+00',
  ...
  },
  {
    ...
    content: {
      ...
      type: 'comment',
      content:
        'Our latest spectroscopic analysis revealed a significant shift in the absorption peaks (Δλ = 15nm) when the sample was exposed to varying pH levels (6.5-8.0). This suggests potential applications in biosensing, particularly for monitoring subtle changes in cellular microenvironments.',
      timestamp: '2024-12-16 12:24:06.069373+00',
      hub: hubs.biophysics,
    ...
    context: {
      ...
      abstract:
        'We present a new class of fluorescent molecular probes that exhibit remarkable sensitivity to physiological pH changes. These probes demonstrate exceptional photostability and minimal photobleaching, making them ideal for long-term cellular imaging applications.',
      ...
      actor: users.sarahChen,
      authors: [users.sarahChen, users.jamesWilson, users.elenaRodriguez],
    },
    contributors: [],
    metrics: {
      votes: 5,
