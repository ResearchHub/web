...
export const LeftSidebar: React.FC = () => {
  ...
  const handleToggleView = (view: 'home' | 'notebook') => {
    const isNotebook = view === 'notebook';
    setIsNotebookView(isNotebook);
    router.push(isNotebook ? '/notebook' : '/');
  };
  ...
  return (
    <div className="w-64 fixed h-screen border-r overflow-y-auto flex flex-col z-30">
      ...
      <div className="border-t">
        <button
          onClick={() => handleToggleView('notebook')}
