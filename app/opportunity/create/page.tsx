      ...
      <div className="w-full max-w-3xl mx-auto space-y-8 py-8">
        <div className="text-center pb-8">
          <div className="flex flex-col items-center gap-3">
            <h1 className="text-4xl font-bold text-gray-900">Create a Funding Opportunity</h1>
                ...
                <div className="grid md:grid-cols-2 gap-x-6 gap-y-8">
                  {[
                    ...
                    },
                    {
                      ...
                      text: 'We assign a dedicated contact person to ensure your process is smooth and successful.',
                      iconName: 'LifeBuoy',
                      style: {
                        iconColor: 'text-black-500',
                        titleColor: 'text-black-700',
            ...
            <div className="space-y-10">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Describe the objectives of your funding opportunity..."
                  rows={5}
                  required
                />
              </div>
