        ...
        <div className="space-y-12">
          ...
          <div className="space-y-8">
            ...
            {formData.rewardFunders && (
              <>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">NFT Art</label>
                  <div
                ...
                {pricePerNFT > 0 && (
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <p className="text-sm text-gray-600">
                      Based on your budget of ${formData.budget} and supply of {formData.nftSupply}{' '}
                      NFTs, funders contributing ${pricePerNFT.toFixed(2)} USD will receive an
                      acknowledgement NFT in return.
                    </p>
                  </div>
                )}
              </>
