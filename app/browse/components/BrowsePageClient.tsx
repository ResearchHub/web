...
export function BrowsePageClient({ initialTopics }: BrowsePageClientProps) {
  ...
  const { followedTopics, getFollowedTopics, followedTopicObjects, getFollowedTopicObjects } =
    useFollowContext();
  ...
  }, [activeTab, getFollowedTopicObjects]);
      ...
      <div className="py-4 max-w-7xl mx-auto">
        {isAllTab ? (
          <>
            ...
            {showAllTopics && <TopicList topics={initialTopics} />}
          </>
        ) : (
          <>
            {hasFollowedTopics ? (
