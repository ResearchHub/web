...
/**
 * Redesigned Post menu (RFP + Proposal). Not wired into the sidebar yet —
 * live UI still uses PublishMenu.
 */
...
export const PostMenu: React.FC<PostMenuProps> = ({ forceMinimize = false }) => {
  ...
  const handleMenuItemClick = (item: (typeof POST_MENU_SECTIONS)[number]['items'][number]) => {
  ...
  const menuContent = (
    <>
      ...
      <div className="space-y-3 p-0.5">
        {POST_MENU_SECTIONS.map((section) => (
