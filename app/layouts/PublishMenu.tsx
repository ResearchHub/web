...
import { Plus, FileUp, BadgeCheck, HandCoins } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className=" space-y-2">
        <BaseMenuItem onClick={() => router.push('/work/create')} className="w-full px-2">
        ...
        <BaseMenuItem onClick={() => router.push('/work/claim')} className="w-full px-2">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0">
              <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center">
            ...
            <div className="flex-1">
              <div className="text-sm font-large tracking-[0.02em] text-gray-900">Claim paper</div>
              <div className="text-xs text-gray-600 mt-0.5">
        ...
        <BaseMenuItem onClick={() => router.push('/grant/create')} className="w-full px-2">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <div className="text-sm font-large tracking-[0.02em] text-gray-900">Open a grant</div>
              <div className="text-xs text-gray-600 mt-0.5">
