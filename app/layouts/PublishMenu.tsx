...
export const PublishMenu: React.FC<PublishMenuProps> = ({ children, forceMinimize = false }) => {
  ...
  const handleOpenGrant = () => {
    router.push('/notebook?newRfp=true');
  };
              ...
              <BaseMenuItem onClick={() => router.push('/paper/create')} className="w-full px-2">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-600 mt-0.5">
                      Share your completed research or preprint
                    </div>
                  </div>
                </div>
              </BaseMenuItem>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-600 mt-0.5">
                      Get community support for your research project
                    </div>
                  </div>
                </div>
              </BaseMenuItem>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-600 mt-0.5">
                      Fund specific research areas you care about
                    </div>
                  </div>
                </div>
              </BaseMenuItem>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-600 mt-0.5">
                      Reward researchers for solving specific problems
                    </div>
                  </div>
                </div>
              </BaseMenuItem>
