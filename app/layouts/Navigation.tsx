...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  const getButtonStyles = (path: string, currentPath: string) => {
    ...
    return isActive
      ? `flex items-center w-full px-5 py-3.5 text-[15px] font-medium text-blue-600 ${responsiveClasses} bg-blue-50 rounded-lg group`
  ...
  const NavLink: React.FC<{
    ...
    const iconColor = isActive ? '#0B60EA' : '#404040'; // blue-600 for active, gray-600 for inactive
