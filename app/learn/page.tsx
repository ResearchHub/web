          ...
          <div className="py-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                {/* Hero Section */}
                <div className="mb-12">
                  <h2 className="text-4xl font-bold mb-4">Accelerating Scientific Research</h2>
                  <p className="text-lg text-gray-600">
                    The scientific record is too important to be hidden behind paywalls and in ivory
                    towers. Science should be open: not only for reading, but also for reusing.
                  </p>
                </div>
                ...
                <section className="mb-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-gray-600">
                      ...
                      between the ResearchHub Foundation and Researchhub Technologies, Inc. -
                      Together, we are a collection of skeptical, yet optimistic individuals who
                      want to accelerate the pace of science.
                    </p>

                    <p className="text-gray-600 font-medium">
                      We think the incentives of scientific funding and publishing are broken, and
                      that blockchain can help.
                    </p>
                ...
                <section className="mb-12">
                  ...
                  <p className="text-gray-600 mb-4">
                    The modern economic model for scientific research is antiquated. A simplified
                    description is as follows: Funders distribute capital to scientists who conduct
                    research projects and share the results as scientific papers published within an
                    academic journal.
                  </p>
                ...
                <section className="mb-12">
                  ...
                  <div className="prose max-w-none">
                    <p className="text-gray-600 mb-6">
                      ResearchCoin (RSC) is a reward token anyone can earn by sharing, curating, and
                      discussing academic science within ResearchHub. The number of RSC earned for
                      any given action is proportional to how valuable the community perceives that
                      action to be. Within ResearchHub, RSC is used to properly recognize and reward
                      users who help create value within our community, and in doing so, bring the
