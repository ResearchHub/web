...
interface PoolReadyGateProps {
  children: ReactNode;
}

/**
 * Hides a campaign landing page until styled-jsx CSS has been applied to the
 * DOM (specifically, until after the first paint frame following mount).
 *
 ...
 * is styled.
 */
export function PoolReadyGate({ children }: Readonly<PoolReadyGateProps>) {
