...
export const ResearchCoin = () => (
  <section id="rsc" className="py-12 sm:py-16 md:py-24 lg:py-28 bg-white border-t border-gray-100">
    <AboutContainer>
      <div className="grid gap-6 md:grid-cols-12 md:gap-10 items-start mb-8 sm:mb-12 md:mb-16">
        ...
        <div className="md:col-span-7 md:pt-6">
          <p className="text-base sm:text-[17px] md:text-[18px] leading-[1.6] text-gray-500">
            <span className="text-gray-900 font-medium">ResearchCoin (RSC)</span> is an ERC20 token
