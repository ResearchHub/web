    ...
    <div className="flex-1 overflow-y-auto py-2">
      ...
      {isTyping && (
        <div className="flex items-start gap-3 px-4 py-3 animate-in fade-in duration-300">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-indigo-50/30 rounded-2xl rounded-tl-md px-4 py-3">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs text-indigo-400 ml-1">Thinking...</span>
            </div>
          </div>
        </div>
      )}
