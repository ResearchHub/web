          ...
          <div className="flex flex-col mobile:flex-row mobile:items-center mobile:justify-between gap-3 mobile:gap-0">
            {showContribute && (
              <Button
                ...
                size="sm"
                disabled={!isActive}
                className="flex items-center justify-center mobile:justify-start gap-1 py-1 w-full mobile:w-auto"
          ...
          <div className="flex flex-col mobile:flex-row mobile:items-center mobile:justify-between gap-4 mobile:gap-0">
            {showContribute && (
              <Button
                ...
                size="lg"
                disabled={!isActive}
                className="flex items-center justify-center mobile:justify-start gap-1.5 w-full mobile:w-auto"
                onClick={handleContributeClick}
              >
