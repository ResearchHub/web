...
const REWARD_TYPES = [
  ...
  },
  {
    ...
    name: 'Something Else',
    description:
      'For answering questions, expert analysis, methodology help, datasets, or code implementation',
...
export function CreateRewardModal({ isOpen, onClose }: CreateRewardModalProps) {
  ...
  const RSC_TO_USD = 0.5; // Hardcoded exchange rate: 1 RSC = $0.50 USD
              ...
              <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white p-6 shadow-xl transition-all">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-4">
                    <div>
                      <label className="text-base font-semibold text-gray-900">Reward Type</label>
                            ...
                            >
                              {({ checked }) => (
                                <div className="flex w-full items-center">
                                  <div
                                    className={`${checked ? 'text-white' : 'text-indigo-600'} mr-4`}
                                  >
                                    {type.icon}
                                  </div>
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        {140 - summary.length} characters remaining
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <div className="text-sm text-gray-500">
                        Balance:{' '}
                        <span className="font-medium">{userBalance.toLocaleString()} RSC</span>
