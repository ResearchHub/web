...
import { Bell, Share2, Copy, Check, Link } from 'lucide-react';
              ...
              <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white p-8 text-left align-middle shadow-xl transition-all">
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex flex-col md:!flex-row gap-2 md:!gap-4">
                    <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-white ring-6 ring-white self-center md:!self-start">
                      <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary-50/70">
                        <Bell className="h-6 w-6 text-primary-600 stroke-[1.5]" strokeWidth={1.5} />
                      </div>
                    </div>
                    <div className="pt-1">
                  ...
                  <div className="flex flex-col md:!flex-row gap-2 md:!gap-4">
                    <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-white ring-6 ring-white self-center md:!self-start">
                      <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary-50/70">
                        <Share2
                          className="h-6 w-6 text-primary-600 stroke-[1.5]"
                          strokeWidth={1.5}
                        />
                      </div>
                    </div>
