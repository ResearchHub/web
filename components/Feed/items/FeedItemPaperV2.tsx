...
import { Users, FileText, Eye, CheckSquare, BookOpen } from 'lucide-react';
...
export function FeedItemPaperV2({
  ...
  // Create action text with source
  const actionText = graphqlData.source
    ? `published in ${graphqlData.source}`
    : 'published a paper';
  ...
  return (
    <div className="space-y-3">
      ...
      {paper.publishedDate && (
        <FeedItemHeader
          timestamp={paper.publishedDate}
          authors={authors}
          actionText={actionText}
          source={graphqlData.source}
      ...
      <CardWrapper>
        <div className="p-4">
          {/* Category and Subcategory Badges - Top Row (no source badge here) */}
