...
import { ArrowRight, CalendarOff, ShieldCheck, ShieldQuestion, ShieldX, Star } from 'lucide-react';
...
const AiVerdictBadge: FC<{ rating: OverallRating | null }> = ({ rating }) => {
    ...
    >
      ...
      <div className="flex-shrink-0 flex items-center gap-2 justify-end">
        {fundraise.reviewMetrics && fundraise.reviewMetrics.avg > 0 ? (
          <span className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-[12px] font-medium bg-amber-50 border border-amber-200 text-amber-700">
