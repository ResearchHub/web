      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <div className="flex flex-1 items-start gap-3">
          <div className="flex shrink-0 items-center justify-center rounded-lg bg-[#E3F3C1] p-2">
            <FontAwesomeIcon icon={faOrcid} className="h-5 w-5" color="#A6CE39" />
          </div>
        ...
        <Button
          ...
          size="default"
          className="w-full flex-shrink-0 bg-[#A6CE39] text-white hover:bg-[#95BC33] focus-visible:ring-[#A6CE39] sm:w-auto"
        >
