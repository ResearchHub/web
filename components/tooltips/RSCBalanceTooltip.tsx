...
export interface RSCBalanceTooltipProps {
  title: string;
  children: ReactNode;
...
/**
 * Shared RSC balance help content. Used by ResearchCoin (State 1) and
 * Available (State 2) tooltips — same body, different title.
 */
export function RSCBalanceTooltip({
  title,
  children,
  position = 'top',
  wrapperClassName,
