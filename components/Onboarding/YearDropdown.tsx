    ...
    <Dropdown
      ...
      trigger={
        <button
          type="button"
          className={cn(
            'flex w-full items-center justify-between rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm leading-6 text-left focus:outline-none focus:ring-2 focus:ring-indigo-500',
            !value && 'text-gray-500',
            className
          )}
        >
