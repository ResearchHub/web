...
export const ImageUploader = ({ onUpload }: { onUpload: (url: string) => void }) => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-8 rounded-md min-h-[10rem] bg-opacity-80">
  ...
  const wrapperClass = cn(
    'flex flex-col items-center justify-center px-8 py-10 rounded-md bg-opacity-80',
