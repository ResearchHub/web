            ...
            <div className="group">
              ...
              {openSections.includes('what-is-rsc') && (
                <div className={`pl-6 py-3 text-sm text-gray-600 border-l border-gray-100`}>
                  ResearchCoin (RSC) is a digital currency that incentivizes good science by
                  allowing users to create grants, reward quality contributions, and fund open
                  science initiatives on ResearchHub.
                </div>
              )}
            </div>
            ...
            <div className="group">
              ...
              {openSections.includes('why-rsc') && (
                <div className={`pl-6 py-3 text-sm text-gray-600 border-l border-gray-100`}>
                  ...
                  rewarded for their contributions to science. It helps bridge the gap between
                  valuable research work and financial recognition.
                </div>
              )}
            </div>
        ...
        <div className="px-6 py-4">
          ...
          <div className="space-y-1">
            ...
            <div className="group">
              ...
              {openSections.includes('create-reward') && (
                <div className={`pl-6 py-3 text-sm text-gray-600 border-l border-gray-100`}>
                  RSC empowers the reward system on ResearchHub, connecting researchers with
                  tailored opportunities. Users can create rewards to engage experts for tasks like
            ...
            <div className="group">
              ...
              {openSections.includes('governance') && (
                <div className="pl-6 py-3 text-sm text-gray-600 border-l border-gray-100">
                  RSC puts governance in the hands of researchers, allowing them to collectively
                  shape the incentive structures in their fields. Through voting and proposal
                  mechanisms, the research community can determine how to best reward different
        ...
        <div className="px-6 py-4">
          ...
          <div className="space-y-1">
            ...
            <div className="group">
              ...
              {openSections.includes('upvotes') && (
                <div className="pl-6 py-3 text-sm text-gray-600 border-l border-gray-100">
                  Researchers earn RSC by receiving upvotes on their contributions to open
                  scientific discourse, incentivizing critical discussions and informal exchanges.
                </div>
              )}
            </div>
          </div>
