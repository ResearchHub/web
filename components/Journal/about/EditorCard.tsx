      ...
      <div className={cn('flex items-start', isLarge ? 'space-x-8' : 'space-x-3')}>
        ...
        <div className="flex-grow">
          ...
          <div className={cn('flex mt-1', isLarge ? 'space-x-3 mt-2' : 'space-x-2')}>
            <button
              type="button"
              className="text-gray-400 hover:text-primary-600 p-0 bg-transparent border-none cursor-pointer"
              aria-label={isMailHovered ? `Copy ${editorEmail}` : `Email ${editor.name}`}
